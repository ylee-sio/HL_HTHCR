...
read -p 'Enter full species identifier or name (Ex:danio_rerio): ' species_name
read -p 'Enter initials for species (Ex: dr): ' species_initial
read -p 'Enter name of whitespace-free sequence file (not full path): ' accession
num_probe_pairs=50
      ...
      do
        ...
        while [ $test_probe != "pass" ]
	      ...
	      echo " "
              ...
              echo "Please re-enter an existing NCBI protein accession ID or check that you are entering the correct file name."
